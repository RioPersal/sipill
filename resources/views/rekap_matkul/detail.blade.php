      ...
      <table class="table table-sm table-bordered">
          <thead>
            <tr>
              ...
              @endforeach
              {{-- <th class="text-center align-middle col-2" rowspan="5">Aksi</th> --}}
            </tr>
            ...
            @endphp --}}
                <tr>
                  ...
                  {{-- <td class="text-center align-middle">
                    ...
                    <a href="{{url('/data-penilaian/'.$kelas->id.'/create/'.$value->id)}}" class="btn btn-sm col btn-outline-success"><i class="fa fa-plus"></i>Tambah Nilai</a>
                        
                    @else
                    <a href="{{url('/data-penilaian/'.$kelas->id.'/edit/'.$value->id)}}" class="btn btn-sm col btn-outline-warning"><i class="fa fa-edit"></i>Edit Nilai</a>
