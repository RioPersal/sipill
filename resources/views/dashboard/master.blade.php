        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              @if (auth()->user()->level === 'kaprodi')
                ...
                {{-- <li class="nav-item">
                  <a href="/data-peserta-kelas" class="nav-link @if(Request::is('data-peserta-kelas')) active @endif">
                    <i class="fa-regular fa-file nav-icon align-middle"></i>
                    <p>Data Peserta Kelas</p>
                  </a>
                </li> --}}
                <li class="nav-item">
                ...
                {{-- <li class="nav-item">
                  <a href="/data-tahun-akademik" class="nav-link @if(Request::is('data-tahun-akademik')) active @endif">
                    <i class="fa-regular fa-file nav-icon align-middle"></i>
              ...
              <li class="nav-item">
                <a href="/data-penilaian" class="nav-link">
                  <i class="fa-regular fa-square-plus nav-icon align-middle"></i>
                  <p class="align-middle">Tambah Penilaian</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/data-peserta-kelas" class="nav-link">
                  <i class="fa-regular fa-file nav-icon align-middle"></i>
                  <p>Data Peserta Kelas</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="/data-tahun-akademik" class="nav-link">
                  <i class="fa-regular fa-file nav-icon align-middle"></i>
                  <p>Data Tahun Akademik</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/cpmk" class="nav-link">
                  <i class="fa-regular fa-file nav-icon align-middle"></i>
                  <p>CPMK</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/pemetaan-matkul-dan-cpmk" class="nav-link">
                  <i class="fa-regular fa-file nav-icon align-middle"></i>
                  <p>Matkul vs Indikator CPL</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/indikator-cpl" class="nav-link">
                  <i class="fa-regular fa-file nav-icon align-middle"></i>
                  <p>Indikator CPL</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/cpl-prodi" class="nav-link">
                  <i class="fa-regular fa-file nav-icon align-middle"></i>
                  <p>CPL Prodi</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="/data-kaprodi" class="nav-link">
                  <i class="fa-solid fa-user nav-icon align-middle"></i>
                  <p>Data Kaprodi</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="/rekap-nilai-mahasiswa" class="nav-link">
                  <i class="fa-solid fa-chart-column nav-icon align-middle"></i>
                  <p>Rekap CPL Mahasiswa</p>
                </a>
              </li> --}}
              ...
              {{-- <li class="nav-item">
                <a href="/data-prodi" class="nav-link">
                  <i class="fas fa-minus nav-icon align-middle"></i>
                  <p>Data Prodi</p>
                </a>
              </li> --}}
          ...
          {{-- <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/rekap-program-studi" class="nav-link">
                  <i class="fas fa-minus nav-icon align-middle"></i>
                  <p>Rekap CPL Prodi</p>
                </a>
              </li>
