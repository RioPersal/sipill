          ...
          <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    @foreach ($pesertas->where('id_mahasiswa', $mhs->id) as $peserta)
                      ...
                      @for ($i = 1; $i < $cepeel+1; $i++)
                          ...
                          {{-- @else
                            <th class="text-center align-middle bg-light" style="white-space: nowrap;">
                              #
                            </th>
                          @endif --}}
                        @endfor
              ...
              <tfoot>
                  <tr>
                    ...
                    {{-- @php
                      $datanilai = array();
                      $json_datanilai = json_encode($datanilai);
                    @endphp
                    @for ($j = 1; $j < $cepeel+1; $j++)
                    @php
                      $dtaa = [${"nilai$j"}];
                      array_push($datanilai, $dtaa);
                    @endphp
                  @endfor --}}
                  {{-- @php
                      dd($datanilai);
